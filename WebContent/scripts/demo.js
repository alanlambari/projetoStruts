...
$(function () {
    ...
    var estacoesArray = $.map(estacoes, function (value, key) { return { value: value, data: key }; });
    ...
    $.mockjax({
        ...
        response: function (settings) {
            var query = settings.data.query,
                ...
                suggestions = $.grep(estacoesArray, function (estacao) {
                    return re.test(estacao.value);
                }),
                response = {
                    query: query,
    ...
    $('#autocomplete').devbridgeAutocomplete({
        ...
        noSuggestionNotice: 'Desculpe, não existe estação com esse nome',
        groupBy: 'category'
    });
